<%-- 
    Document   : Profile_
    Created on : 07-Jan-2023, 8:57:11 am
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="list-group">
                            <a href="#" onclick="getPosts(0, this)" class="list-group-item list-group-item-action active_ c-link">
                                All Posts
                            </a>
                            <%
                                PostDao pd = new PostDao(ConnectionProvider.getConnection());
                                ArrayList<Category> list_Cat = pd.getAllCategorys();
                                for(Category cc: list_Cat){                                                                 
                            %>
